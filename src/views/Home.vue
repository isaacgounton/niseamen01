<template>
  <div class="bg-white/10 backdrop-blur-2xl shadow-2xl overflow-hidden rounded-lg">
    ...
    <div class="p-4 sm:p-8 space-y-4 sm:space-y-6">
      ...
      <!-- Playlist with fixed height -->
      <div class="bg-white/5 rounded-lg p-4 mb-6 h-[calc(100vh-32rem)] sm:h-96 overflow-y-auto">
        <div 
